...
export const productsTable: ProductRecord[] = [
  ...
  },
  {
    ...
    // relatedProductSlugs: ["dell-xps-13-plus-9320", "macbook-air-m2-8gb-256gb"],
  },
  {
    slug: "macbook-air-m3-13-2024",
    name: "MacBook Air M3 13\" 2024 (8GB/256GB)",
    brand: "Apple",
    collectionLabel: "MacBook Air",
    category: "Mong nhe",
    coverImage: officeGallery[2] || officeGallery[0],
    gallery: officeGallery,
    cardSpecs: "Apple M3 | 8GB | 256GB | 13.6 inch",
    currentPrice: 27990000,
    originalPrice: 29990000,
    reviewRating: 5.0,
    reviewCount: 42,
    badges: [{ label: "Mới về", tone: "good" }],
    financingText: "2.330.000đ/tháng",
    cartNote: "Sẵn hàng tại Hà Nội & HCM",
    fitForYou: ["Cần hiệu năng chip M3 mới nhất", "Ưu tiên thiết kế mỏng nhẹ đẳng cấp"],
    cautionNotes: ["8GB RAM có thể hạn chế khi làm việc chuyên nghiệp nặng"],
    highlights: [
      { label: "Chip", value: "Apple M3", icon: "cpu" },
      { label: "Display", value: "13.6\" Liquid Retina", icon: "display" },
    ],
    specifications: [
    ...
    reviewPoints: [{ title: "Chip M3 mạnh mẽ", detail: "Xử lý tác vụ nhanh hơn đáng kể so với M1." }],
    comparePoints: ["Mạnh hơn M2 khoảng 15-20%."],
    relatedSlugs: ["macbook-air-m2-8gb-256gb"],
  },
  {
    slug: "lenovo-legion-pro-5-gen-9-2024",
    name: "Lenovo Legion Pro 5 Gen 9 2024",
    brand: "Lenovo",
    collectionLabel: "Lenovo Legion",
    category: "Gaming",
    coverImage: gamingGallery[1] || gamingGallery[0],
    gallery: gamingGallery,
    cardSpecs: "i9 14900HX | 32GB | 1TB | RTX 4070",
    currentPrice: 38490000,
    originalPrice: 42990000,
    reviewRating: 4.9,
    reviewCount: 15,
    badges: [{ label: "Mới về", tone: "good" }],
    financingText: "3.200.000đ/tháng",
    cartNote: "Sẵn hàng tại kho",
    fitForYou: ["Game thủ chuyên nghiệp", "Cần hiệu năng tối đa từ i9 thế hệ 14"],
    cautionNotes: ["Trọng lượng khá nặng", "Cục sạc to"],
    highlights: [
      { label: "CPU", value: "Core i9 14900HX", icon: "cpu" },
      { label: "GPU", value: "RTX 4070", icon: "gpu" },
    ],
    specifications: [
      { label: "CPU", value: "Intel Core i9 14900HX" },
      { label: "RAM", value: "32GB DDR5" },
    ],
    reviewPoints: [{ title: "Tản nhiệt xuất sắc", detail: "Hệ thống Legion Coldfront 5.0 cực mát." }],
    comparePoints: ["Đứng đầu phân khúc gaming cận cao cấp."],
    relatedSlugs: ["lenovo-legion-5-15iah7h"],
  },
  {
    slug: "dell-xps-14-9440-ultra-7-155h",
    name: "Dell XPS 14 9440 Ultra 7 155H",
    brand: "Dell",
    collectionLabel: "Dell XPS",
    category: "Gaming", // Reusing category for now or should add "Do hoa"
    coverImage: officeGallery[3] || officeGallery[1],
    gallery: officeGallery,
    cardSpecs: "Ultra 7 155H | 16GB | 512GB | OLED Touch",
    currentPrice: 52990000,
    originalPrice: 58000000,
    reviewRating: 4.8,
    reviewCount: 8,
    badges: [{ label: "Sắp về", tone: "fresh" }],
    financingText: "4.410.000đ/tháng",
    cartNote: "Dự kiến về hàng 20/04",
    fitForYou: ["Doanh nhân, người dùng cao cấp", "Cần màn hình OLED cảm ứng tuyệt đẹp"],
    cautionNotes: ["Giá thành rất cao"],
    highlights: [
      { label: "CPU", value: "Ultra 7 155H", icon: "cpu" },
      { label: "Display", value: "14.5\" 3.2K OLED", icon: "display" },
    ],
    specifications: [
      { label: "CPU", value: "Intel Core Ultra 7 155H" },
      { label: "RAM", value: "16GB LPDDR5x" },
    ],
    reviewPoints: [{ title: "Thiết kế tương lai", detail: "Bàn phím và touchpad tàng hình ấn tượng." }],
    comparePoints: ["Đẳng cấp vượt trội so với các dòng máy văn phòng khác."],
    relatedSlugs: ["dell-xps-13-plus-9320"],
  },
  {
    slug: "macbook-pro-14-m3-pro-18gb-512gb",
    name: "MacBook Pro 14 M3 Pro (18GB/512GB)",
    brand: "Apple",
    collectionLabel: "MacBook Pro",
    category: "Do hoa",
    coverImage: officeGallery[0],
    gallery: officeGallery,
    cardSpecs: "M3 Pro | 18GB | 512GB | 14 inch",
    currentPrice: 49990000,
    originalPrice: 52990000,
    reviewRating: 4.9,
    reviewCount: 26,
    badges: [{ label: "Mới về", tone: "good" }],
    financingText: "4.160.000đ/tháng",
    cartNote: "Sẵn hàng màu Space Black",
    fitForYou: ["Lập trình viên, designer", "Cần hiệu năng đồ họa mạnh từ chip Pro"],
    cautionNotes: ["Giá cao"],
    highlights: [
      { label: "Chip", value: "Apple M3 Pro", icon: "cpu" },
      { label: "RAM", value: "18GB Unified", icon: "memory" },
    ],
    specifications: [
      { label: "Chip", value: "Apple M3 Pro" },
      { label: "RAM", value: "18GB" },
    ],
    reviewPoints: [{ title: "Thời lượng pin", detail: "Làm việc cả ngày không cần sạc." }],
    comparePoints: ["Màu Space Black cực đẹp và chống bám vân tay."],
    relatedSlugs: ["macbook-air-m2-8gb-256gb"],
  },
];
